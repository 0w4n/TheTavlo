...
describe("buildPanelPath", () => {
    ...
    it("arma el detalle de una tarea", () => {
        expect(buildPanelPath(["abc"], { type: "task-detail", taskId: "t1" })).toBe("/home/abc/task/t1");
    });
    it("arma el calendario y el detalle de un evento", () => {
        expect(buildPanelPath(["abc", "def", "ghi"], { type: "calendar" })).toBe("/home/abc/def/ghi/calendar");
        expect(buildPanelPath(["abc", "def", "ghi"], { type: "event-detail", eventId: "e1" })).toBe("/home/abc/def/ghi/calendar/e1");
    });
