...
export function AnnouncerProvider({ children }) {
    ...
    return (_jsxs(AnnouncerContext.Provider, { value: announce, children: [children, _jsx("div", { "aria-live": "polite", "aria-atomic": "true", style: hiddenStyle, children: messageA }), _jsx("div", { "aria-live": "polite", "aria-atomic": "true", style: hiddenStyle, children: messageB })] }));
}
