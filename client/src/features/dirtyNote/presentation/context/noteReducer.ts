...
export type NoteState =
  ...
  | {
      status: "notes";
      selectedNotes?: DirtyNote;
      currentNotes: DirtyNote[];
    }
  | {
      status: "error";
      error?: AppErr;
...
type NoteAction =
  ...
  | { type: "FETCH_NOTES_SUCCESS"; payload: DirtyNote[] }
  | { type: "FETCH_NOTES_ERROR"; payload: AppErr }
  | { type: "CREATE_NOTE_SUCCESS"; payload: DirtyNote }
  | { type: "UPDATE_NOTE_SUCCESS"; payload: DirtyNote }
  | { type: "DELETE_NOTE_SUCCESS"; payload: string }
  | { type: "SELECT_NOTE"; payload: DirtyNote }
  | { type: "CLEAR_ERROR" };
