...
export function suggestStarterWidget(goals) {
...
export const FIRST_TASK_DUE_OPTIONS = [
...
// ─── Copys contextuales ─────────────────────────────────────────────────────
export function suggestSpacePlaceholder(goals) {
    if (goals.includes("team"))
        return "Ej. Proyecto Q3";
    if (goals.includes("study"))
        return "Ej. Segundo cuatrimestre";
    if (goals.includes("deadlines"))
        return "Ej. Entregas de noviembre";
    return "Ej. Mi espacio";
}
export function suggestTaskPlaceholder(goals) {
    if (goals.includes("study"))
        return "Ej. Repasar el tema 3";
    if (goals.includes("team"))
        return "Ej. Enviar el brief a diseño";
    if (goals.includes("deadlines"))
        return "Ej. Entregar el informe mensual";
