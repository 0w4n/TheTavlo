...
export type UpsertAttendanceDTO = Omit<AttendanceRecord, "id" | "createdAt" | "updatedAt">;
/**
 ...
 */
export declare function buildAttendanceId(slotGroupId: string, localDateKey: string): string;
