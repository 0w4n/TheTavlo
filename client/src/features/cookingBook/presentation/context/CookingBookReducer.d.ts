...
type CookingBookAction = {
    type: "FETCH_COOKINGNOOK_START";
};
export declare const initialCookingBookState: CookingBookState;
export declare function cookingRecipeReducer(state: CookingBookState, action: CookingBookAction): CookingBookState;
export {};
